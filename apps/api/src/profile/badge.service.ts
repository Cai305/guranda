...
const SEED_BADGES: { code: string; name: string; description: string; icon: string; maxSupply: number | null }[] = [
  ...
  { code: 'SPONSORED_VIEWER', name: 'Sponsored Viewer', description: 'Earned Rand watching a sponsored video.', icon: '🤝', maxSupply: null },
  { code: 'PROMO_VIEWER', name: 'Promo Viewer', description: 'Earned Rand watching a promo video.', icon: '📣', maxSupply: null },
  { code: 'CAMPAIGN_VIEWER', name: 'Campaign Viewer', description: 'Earned Rand watching a campaign video.', icon: '🚩', maxSupply: null },
  { code: 'ADVERT_VIEWER', name: 'Advert Viewer', description: 'Earned Rand watching an advert.', icon: '📺', maxSupply: null },
  { code: 'MUSIC_LISTENER', name: 'Music Listener', description: 'Earned Rand watching a music video.', icon: '🎵', maxSupply: null },
];
