  ...
  onModuleInit() {
    this.registry.registerMany(
      defineTools('gifts', [
        {
          name: 'catalog',
          description: 'List the available gift types and their Rand cost.',
