...
export default function EatStoreScreen({ navigation, route }: any) {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: itemCount > 0 ? 100 : 40 }}>
        {/* Cover */}
        <LinearGradient colors={['#ef4444', '#b91c1c']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.cover}>
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backBtn}>
            <Ionicons name="arrow-back" size={22} color="#fff" />
          </TouchableOpacity>
          <Ionicons name="restaurant" size={52} color="rgba(255,255,255,0.25)" />
        </LinearGradient>
        ...
        <View style={styles.storeInfo}>
          <View style={styles.storeHeader}>
            <View style={styles.logoWrap}>
              <Ionicons name="restaurant" size={28} color="#ef4444" />
            </View>
          ...
          <View style={styles.metaRow}>
            ...
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText} numberOfLines={1}>{store.address}</Text>
            </View>
          </View>

          <View style={styles.feeBanner}>
            <View style={styles.feeItem}>
              <Ionicons name="bicycle" size={16} color="#ef4444" />
              <Text style={styles.feeLabel}>R20 delivery</Text>
            </View>
            <View style={styles.feeDivider} />
            <View style={styles.feeItem}>
              <Ionicons name="pricetag-outline" size={16} color="#ef4444" />
              <Text style={styles.feeLabel}>1.5% service fee</Text>
            </View>
            <View style={styles.feeDivider} />
            <View style={styles.feeItem}>
                ...
                <View key={product.id} style={styles.productCard}>
                  ...
                  <View style={styles.productActions}>
                    ...
                    {qty === 0 ? (
                      <TouchableOpacity
                        style={styles.addBtn}
                        onPress={() => addItem(product, store.id, store.name)}
                      >
      ...
      {itemCount > 0 && (
        <View style={styles.cartBar}>
          <TouchableOpacity style={styles.cartBarBtn} onPress={() => navigation.navigate('EatCart')}>
...
const styles = StyleSheet.create({
  ...
  storeCat: { color: '#ef4444', fontSize: 12, fontWeight: '600' },
  ...
  productPrice: { color: '#ef4444', fontWeight: '700', fontSize: 15 },
